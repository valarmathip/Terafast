...
def productInfo(opr):
    ...
    if opr == "selectedProductInfo":
        ...
        selectedProductInfo('ports,serial_number,manufacturer,model_name,software_version','ports,serial-number,manufacturer,model-name,software-version', '1-24/port-type,has_opm,has_oxc', 'selectedProductInfo.xml')
